define([], function() {
  return {
    ...
    "durationField":"Duration for opportunity",
      "durationDescription":"Using the drop-down menu, select the duration that most closely corresponds with your opportunity type. Deployments are considered permanent staffing actions, so you cannot select a  period for them.",
    "length":"Length",
    "_period":"Time period",
    ...
    "writtenENField": "English written expression",
    "readingENField": "English reading comprehension",
    "oralENField": "English oral expression",
    "writtenFRField": "French written expression",
    "readingFRField": "French reading comprehension",
    ...
    "security":"Security level field is required",
    "language":"Language requirements field is required",
    // "languageRequirements":"Language requirement fields are required",
    "writtenEN": "English written expression required",
    "readingEN": "English reading comprehension required",
    "oralEN": "English oral expression required",
    "writtenFR": "French written expression required",
